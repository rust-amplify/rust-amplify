...
mod tests {
    ...
    fn fmt_hex() {
        ...
        assert_eq!(
            format!("{:X}", u_256),
            "00000000111111112222222233333333AAAABBBBCCCCDDDDAAAABBBBCCCCDDDD"
        );
        assert_eq!(
            format!("{:X}", u_512), 
            "00000000111111112222222233333333AAAABBBBCCCCDDDDAAAABBBBCCCCDDDD00000000111111112222222233333333AAAABBBBCCCCDDDDAAAABBBBCCCCDDDD"
        );
        assert_eq!(
            format!("{:X}", u_1024), 
            ""
        );
        assert_eq!(
            format!("{:#X}", u_256),
            "0x00000000111111112222222233333333AAAABBBBCCCCDDDDAAAABBBBCCCCDDDD"
        );
        assert_eq!(
            format!("{:#X}", u_512), 
            "0x00000000111111112222222233333333AAAABBBBCCCCDDDDAAAABBBBCCCCDDDD00000000111111112222222233333333AAAABBBBCCCCDDDDAAAABBBBCCCCDDDD"
        );
        assert_eq!(
            format!("{:#X}", u_1024), 
            ""
        );
    ...
    fn fmt_octal() {
        let mut u_256 = u256([
            0o1112223334445556667777,
            0o0011222333444555666777,
            0o1111111111122222222222,
            0o0000000011111111222222,
        ]);
        let mut u_512 = u512([
            0o1112223334445556667777,
            0o0011222333444555666777,
        ...
        assert_eq!(
            format!("{:o}", u_256),
            "0000000011111111222222111111111112222222222200112223334445556667771112223334445556667777"
        );
        assert_eq!(
            format!("{:o}", u_512),
            "00000000111111112222221111111111122222222222001122233344455566677711122233344455566677770000000011111111222222111111111112222222222200112223334445556667771112223334445556667777"
        );
        assert_eq!(
            format!("{:o}", u_1024),
            ""
        );
        assert_eq!(
            format!("{:#o}", u_256),
            "0o0000000011111111222222111111111112222222222200112223334445556667771112223334445556667777"
        );
        assert_eq!(
            format!("{:#o}", u_512),
            "0o00000000111111112222221111111111122222222222001122233344455566677711122233344455566677770000000011111111222222111111111112222222222200112223334445556667771112223334445556667777"
        );
        assert_eq!(
            format!("{:#o}", u_1024),
            ""
        );
    }
    ...
    fn fmt_binary() {
        ...
        assert_eq!(
            format!("{:b}", u_256),
            ""
        );
        assert_eq!(
            format!("{:b}", u_512),
            ""
        );
        assert_eq!(
            format!("{:b}", u_1024),
            ""
        );
        assert_eq!(
            format!("{:#b}", u_256),
            ""
        );
        assert_eq!(
            format!("{:#b}", u_512),
            ""
        );
        assert_eq!(
            format!("{:#b}", u_1024),
            ""
        );
    }
